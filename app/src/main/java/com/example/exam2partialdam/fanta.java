...
public class fanta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fanta);
        ...
        if(name!=null || password !=null){
            if(!name.equals("")&&!password.equals("")){
                textView_name.setText("Bienvenido "+name+" estas en la pantalla de Fanta");
            }
            else
                textView_name.setText("Los datos que enviaste son incorrectos");
        }
        if (namep !=null){
            Intent intent= new Intent (fanta.this, pedido.class );
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(fanta.this, "pizzas selecionada", Toast.LENGTH_SHORT).show();
            }
        });
    }
