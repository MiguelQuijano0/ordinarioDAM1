...
public class coca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coca);
        ...
        if(name!=null || password !=null){
            if(!name.equals("")&&!password.equals("")){
                textView_name.setText("Bienvenido "+name+" estas en la pantalla de Coca-Cola");
            }
            else
                textView_name.setText("Los datos que enviaste son incorrectos");
        }
        if (namep !=null){
            Intent intent= new Intent (coca.this, pedido.class );
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(coca.this, "pizzas selecionada", Toast.LENGTH_SHORT).show();
            }
        });
    }
