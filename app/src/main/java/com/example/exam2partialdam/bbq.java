    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(name!=null || password !=null){
            if(!name.equals("")&&!password.equals("")){
                textView_name.setText("Bienvenido "+name+" estas en la pantalla de BBQ");
            }
            else
                textView_name.setText("Los datos que enviaste son incorrectos");
        }
        if (namep !=null){
            Intent intent= new Intent (bbq.this, pedido.class );
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(bbq.this, "complemento selecionado", Toast.LENGTH_SHORT).show();
            }
        });
    }
