...
public class queso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_queso);
        ...
        if (namep !=null){
            Intent intent= new Intent (queso.this, pedido.class );
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(queso.this, "pizzas selecionada", Toast.LENGTH_SHORT).show();
            }
        });
    }
