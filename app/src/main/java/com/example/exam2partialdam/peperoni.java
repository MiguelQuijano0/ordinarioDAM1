...
public class peperoni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_peperoni);
        ...
        if(name!=null || password !=null){
            if(!name.equals("")&&!password.equals("")){
                textView_name.setText("Bienvenido "+name+" estas en la pantalla de pizza queso");
            }
            else
                textView_name.setText("Los datos que enviaste son incorrectos");
        }
        if (namep !=null){
            Intent intent= new Intent (peperoni.this, pedido.class );
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(peperoni.this, "pizzas selecionada", Toast.LENGTH_SHORT).show();
            }
        });
    }
